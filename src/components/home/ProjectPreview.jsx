              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {project.text.notebookPath && (
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 border border-navy-500 hover:border-steel-500 text-steel-400 hover:text-white rounded-xl text-xs font-semibold transition-colors whitespace-nowrap"
                  >
